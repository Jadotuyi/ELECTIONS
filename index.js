...
app.post('/ussd', (req, res) => {
    ...
    if (userInput.length === 1 && userInput[0] === '') {
        ...
        response = `CON Welcome to NEC  Election system\n`;
        response += `1. English\n`;
        ...
        if (userInput[2] === '1') {
            ...
            if (voters.has(phoneNumber)) {
                response = userLanguages[phoneNumber] === 'en' ? 
                    ...
                    `END Wamaze gutora. Murakoze!`;
            } else {
                // Voting option selected
                response = userLanguages[phoneNumber] === 'en' ? 
                    `CON Select a candidate:\n1. Paul KAGAME\n2. Frank HABINEZA\n3. Jean MBANDA\n4. Sekikubo BARAFINDA\n5. Daniel HAKIZIMANA` : 
        ...
        if (candidateIndex >= 0 && candidateIndex < candidateNames.length) {
            ...
            response = userLanguages[phoneNumber] === 'en' ? 
                ...
                `END Murakoze Gutora Umukandida ${candidateNames[candidateIndex]}!`;
            ...
            response = userLanguages[phoneNumber] === 'en' ? 
                ...
                `END Ibyo Mwahisemo Ntibikunze. Ongera ugerageze.`;
        }
    }
